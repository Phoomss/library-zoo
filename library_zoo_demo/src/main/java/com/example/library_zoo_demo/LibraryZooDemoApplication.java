...
import com.example.library_zoo_demo.Model.AppUser;
import com.example.library_zoo_demo.Model.Continent;
import com.example.library_zoo_demo.Model.Type;
import com.example.library_zoo_demo.Repository.AnimalRepository;
import com.example.library_zoo_demo.Repository.AppUserRepository;
import com.example.library_zoo_demo.Repository.ContinentRepository;
import com.example.library_zoo_demo.Repository.TypeRepository;

@SpringBootApplication
public class LibraryZooDemoApplication implements CommandLineRunner {

	public static void main(String[] args) {
		SpringApplication.run(LibraryZooDemoApplication.class, args);
	}
	...
	public LibraryZooDemoApplication(ContinentRepository continentRepository, AnimalRepository animalRepository,
