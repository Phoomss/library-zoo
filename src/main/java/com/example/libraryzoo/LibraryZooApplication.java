...
import com.example.libraryzoo.repository.AnimalRepository;
import com.example.libraryzoo.repository.AppUserRepository;
import com.example.libraryzoo.repository.ContinentRepository;
import com.example.libraryzoo.repository.TypeRepository;

@SpringBootApplication
public class LibraryZooApplication implements CommandLineRunner {

	public static void main(String[] args) {
		SpringApplication.run(LibraryZooApplication.class, args);
	}
	...
	public LibraryZooApplication(ContinentRepository continentRepository, AnimalRepository animalRepository,
